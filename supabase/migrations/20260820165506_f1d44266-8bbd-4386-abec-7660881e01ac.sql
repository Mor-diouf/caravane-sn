...
insert into public.organizers (id, name, description, phone, whatsapp, university_id, status, is_pro, rating, commission_rate, verified_at) values
  ('11111111-1111-4111-8111-111111111111','Amicale des étudiants de Dakar','Caravanes hebdomadaires vers Dakar depuis Ziguinchor.','+221 77 111 11 11','+221 77 111 11 11','uasz','approved',true,4.8,8.00, now()),
  ('22222222-2222-4222-8222-222222222222','Amicale des étudiants casamançais','Trajets de nuit avec deux chauffeurs.','+221 77 222 22 22','+221 77 222 22 22','uasz','approved',false,4.7,8.00, now()),
  ('33333333-3333-4333-8333-333333333333','Collectif étudiant UGB','Navettes Saint-Louis / Dakar.','+221 77 333 33 33','+221 77 333 33 33','ugb','approved',false,4.6,8.00, now()),
  ('44444444-4444-4444-8444-444444444444','Bureau des étudiants UIDT','En attente de validation par la plateforme.','+221 77 444 44 44','+221 77 444 44 44','uidt','pending',false,0,8.00, null);

insert into public.caravans (organizer_id, university_id, from_label, to_label, departure_at, pickup, dropoff, price_fcfa, total_seats, seats_left, amenities, about, status) values
  ('11111111-1111-4111-8111-111111111111','uasz','UASZ','Dakar', now() + interval '3 days', 'Campus social de l''UASZ','Gare routière de Dakar',4500,55,12,'{ac,wifi,usb,video}','Départ à 08h précises, présentez-vous 20 minutes avant.','published'),
  ('22222222-2222-4222-8222-222222222222','uasz','UASZ','Thiès', now() + interval '5 days', 'Entrée principale UASZ','Gare de Thiès',4000,50,22,'{ac,usb}','Trajet de jour avec un arrêt à Kaolack.','published'),
  ('33333333-3333-4333-8333-333333333333','ugb','UGB','Dakar', now() + interval '4 days', 'Campus UGB Sanar','Place de l''Obélisque',3500,52,30,'{ac,wifi}','Navette confort avec climatisation.','published'),
  ('11111111-1111-4111-8111-111111111111','ucad','UCAD','Ziguinchor', now() + interval '7 days', 'Campus social UCAD','Gare routière de Ziguinchor',5000,55,6,'{ac,wifi,usb}','Trajet de nuit, deux chauffeurs.','published');