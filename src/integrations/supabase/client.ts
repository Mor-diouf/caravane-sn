...
function createSupabaseClient() {
  ...
  const SUPABASE_URL = import.meta.env['VITE_SUPABASE_URL'] || process.env['SUPABASE_URL'] || "https://szuvxthwsilzlpdqgyvx.supabase.co";
  const SUPABASE_PUBLISHABLE_KEY = import.meta.env['VITE_SUPABASE_PUBLISHABLE_KEY'] || process.env['SUPABASE_PUBLISHABLE_KEY'] || "sb_publishable_CC09O_VBnfHGp_VbUOxrVA_9fR-9KWy";
